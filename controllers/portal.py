...
class CustomerPortal(CustomerPortal):
    ...
    def portal_order_page(self, order_id, report_type=None, access_token=None, message=False, download=False, **kw):
        logging.warning('Override portal order page')
        try:
        ...
        if report_type in ('html', 'pdf', 'text'):
            return self._show_report(model=order_sudo, report_type=report_type, report_ref='sitio_imagen.action_report_saleorder_imagen', download=download)
