...
class WebSiteSaleController(WebsiteSale):
    ...
    def checkout(self, **post):
        ...
        if post.get('express'):
            return request.redirect('/shop/confirm_order?xhr=1')
    ...
    @http.route('/shop/products/autocomOnceplete', type='json', auth='public', website=True)
    ...
    @http.route(['/shop/detail/cart'], type='json', auth='public', website=True)
    def get_cart(self, **kwargs):
        print('Llamada desde ajax rpc')
